(function($) {
   ...
   //9.Gallery masonary style
	...
	//30.Countdown Timer
	if ($('.countdown').length) {
	    $('.countdown').countdown('2018/04/23', function (event) {
	        var $this = $(this).html(event.strftime('' + '<div class="counter-column"><span class="count">%D</span><br><h6>Days</h6></div> ' + '<div class="counter-column"><span class="count">%H</span><span class="colon"></span><br><h6>Hours</h6></div>  ' + '<div class="counter-column"><span class="count">%M</span><span class="colon"></span><br><h6>Mutines</h6></div>  ' + '<div class="counter-column"><span class="count">%S</span><span class="colon"></span><br><h6>Seconds</h6></div>'));
	    });
	}
